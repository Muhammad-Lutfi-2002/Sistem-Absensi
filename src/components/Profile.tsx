      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white border border-slate-100 shadow-sm rounded-3xl p-6 flex flex-col items-center justify-center text-center space-y-4">
          <div className="relative">
            <div className="h-20 w-20 rounded-full bg-blue-600/10 text-blue-700 font-extrabold text-2xl flex items-center justify-center uppercase border-2 border-blue-100">
              {user.nama.charAt(0)}
            </div>
            <div className="absolute -bottom-1 -right-1 bg-blue-600 text-white rounded-full p-1.5 border-2 border-white shadow">
              <Shield size={14} />
            </div>
          </div>
