    ...
    <div className="p-4 md:p-8 space-y-6">
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {/* Legend Banner */}
          <div className="px-4 py-3 bg-slate-50 border border-slate-100 rounded-2xl flex flex-wrap gap-4 items-center justify-between text-[11px] text-slate-500">
            ...
            <div>
              <span>Menampilkan <span className="font-bold text-slate-700">{filteredStudents.length}</span> Siswa</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {filteredStudents.map((student, idx) => {
              ...
              return (
                <div 
                  key={student.nis} 
                  className={`bg-white border p-5 shadow-sm rounded-3xl transition-all duration-300 relative flex flex-col justify-between ${
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className={`h-11 w-11 rounded-full flex items-center justify-center font-bold text-sm shrink-0 border uppercase ${
                    ...
                    <div className="grid grid-cols-5 gap-1.5">
                      {[
                        ...
                        <label key={opt.val} className="cursor-pointer text-center relative select-none">
                          <input
                            type="radio"
                          ...
                          />
                          <div className={`py-1.5 rounded-xl text-xs font-bold border transition duration-200 ${opt.color}`}>
                            {opt.label}
                          </div>
                        </label>
                      ))}
